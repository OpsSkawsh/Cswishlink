      ...
      <section className="py-24 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="corporate-card card-variant-purple p-6 md:p-8 text-center animate-fade-up hover-floating" style={{ animationDelay: '0.2s' }}>
              <Building2 className="h-12 w-12 md:h-16 md:w-16 text-purple mx-auto mb-6" />
              <h3 className="text-xl md:text-2xl font-bold text-foreground mb-4">Strategic Portfolio</h3>
              ...
              <div className="grid grid-cols-2 gap-4 text-center">
                <div>
                  <div className="text-2xl md:text-3xl font-bold text-purple mb-2">1+</div>
                  <div className="text-xs md:text-sm text-muted-foreground">Active Subsidiaries</div>
                </div>
                <div>
                  <div className="text-2xl md:text-3xl font-bold text-purple mb-2">100%</div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-fade-up">
            ...
            <div className="corporate-card card-variant-success p-8 md:p-12 max-w-2xl mx-auto hover-rainbow">
              <Plus className="h-12 w-12 md:h-16 md:w-16 text-success mx-auto mb-6" />
              ...
              <Button size="lg" className="success-gradient text-success-foreground hover-glow px-8">
                Get in Touch
              </Button>
            </div>
          </div>
